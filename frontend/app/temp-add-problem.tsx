...
// --- Helper Functions and Components from your template ---
...
export default function AddProblemPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const problemData = { title, url, platform, difficulty, notes, tags: selectedTags };
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="title" placeholder="e.g., Two Sum" value={title} onChange={(e) => setTitle(e.target.value)} required />
            </div>
            <div className="space-y-2">
              <Label htmlFor="url">URL</Label>
              <Input id="url" type="url" placeholder="https://leetcode.com/problems/two-sum/" value={url} onChange={(e) => setUrl(e.target.value)} required />
            </div>
            ...
            <div className="space-y-2">
              ...
              <TagInput selectedTags={selectedTags} onTagsChange={setSelectedTags} existingTags={existingTags} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="notes">Notes</Label>
              <Textarea id="notes" placeholder="Any thoughts, approach, or key learnings..." value={notes} onChange={(e) => setNotes(e.target.value)} rows={5}/>
            </div>
